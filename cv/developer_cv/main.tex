...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Mateo}}}}} % First name
	
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Martinjak}}}}} % Last name
	
	\vspace{6pt}
	
	{\huge Junior Web Developer} % Career or current job title
\end{minipage}
